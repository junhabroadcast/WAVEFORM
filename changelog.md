...
- **None** 디스플레이 모드 — 타일을 검정 빈 화면으로 비움
- Persistence 슬라이더 하한을 0까지 확장

### 변경

- Persistence **기본값 0** (잔상 없음)
- **I/Q 축**을 HD(BT.709)에서도 항상 표시 (참고용)

### 문서

- README / features / notes / changelog 를 **v2.0.1** 기준으로 갱신
